...
public final class Collection: CollectionQueryable {
    ...
    ///
    /// - returns: The `Value` received from the server as specified in the link of the additional information
    public func findAndUpdate(_ query: Query? = nil, with: Document, arrayFilters: Document? = nil, upserting: Bool? = nil, returnedDocument: ReturnedDocument = .old, sortedBy sort: Sort? = nil, projection: Projection? = nil) throws -> Document {
        var command: Document = ["findAndModify": self.name]
